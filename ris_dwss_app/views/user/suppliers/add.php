    ...
    <div class="col-lg-12">
        <form id="add" method="post" class="form-horizontal" action="<?php echo USER_URL . 'supplier/add'; ?>" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-9">
                    <input type="text" name="form_date" class="form-control required" placeholder="<?php echo $this->lang->line('supplier_form_date'); ?>" value="<?php echo date('d-m-Y', strtotime(get_current_date_time()->get_date_for_db())); ?>">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-9">
                    <input type="text" name="email"  class="form-control required" placeholder="<?php echo $this->lang->line('supplier_email'); ?>"/>
                </div>
            </div>
