...
<script type="text/javascript" >
    ...
    function loadDatatable(){
        ...
        dTable=jQuery('#list_data').dataTable({
            ...
            "sAjaxSource": "<?php echo USER_URL . 'supplier/getjson'; ?>",
        });
    }
...
<?php if (hasPermission('bods', 'addBod')) { ?>
    <div class="row">
        <div class="col-sm-12">
                <a class="pull-right btn btn-green" href="<?php echo USER_URL . 'supplier/add'; ?>" data-toggle="tooltip" title="" data-original-title="<?php echo $this->lang->line('add'); ?>"><i class="clip-plus-circle"></i>&nbsp;<?php echo $this->lang->line('add') .' '. $this->lang->line('supplier'); ?></a>
        </div>
    </div>
<?php } ?>
    ...
    <table class="table table-bordered table-hover" id="list_data">
        <thead class="the-box dark full">
            <tr align="left">
                ...
                <th width="100"><?php echo $this->lang->line('supplier_mobile'); ?></th>
