...
<div class="row">
    <div class="col-sm-12">
        <div class="page-header">
            <h1><?php echo $this->lang->line('edit') ,' ', $this->lang->line('village'); ?></h1>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-lg-12">
        <form id="edit" method="post" class="form-horizontal" action="<?php echo USER_URL . 'village/edit/' . $village->id; ?>">
            ...
            <?php foreach ($this->config->item('custom_languages') as $key => $value) { ?>
                <div class="form-group">
                    ...
                    <div class="col-lg-9">
                        <input type="text" name="<?php echo $key . '_name'; ?>"  class="<?php echo ($key == 'en') ? 'form-control required' : 'form-control'; ?>" placeholder="<?php echo $this->lang->line('village'), ' ', $this->lang->line('name'), ' ', ucwords($value); ?>" value="<?php echo $village->{$key . '_name'} ?>"/>
                    </div>
                </div>
            <?php } ?>
