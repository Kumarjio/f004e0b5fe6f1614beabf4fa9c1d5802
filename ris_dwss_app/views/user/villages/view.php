...
<script type="text/javascript" >
    ...
    function loadDatatable(){
        ...
        dTable=jQuery('#list_data').dataTable({
            ...
            "sAjaxSource": "<?php echo USER_URL . 'village/getjson'; ?>",
        });
    }
        ...
        swal(
            ...
            function(isConfirm){
                if (isConfirm) {
                    jQuery.ajax({
                        type: 'POST',
                        url: http_host_js + 'village/delete/' + current_id,
                        data: id = current_id,
                        dataType : 'JSON',
...
<div class="row">
    <div class="col-sm-12 col-sm-6 col-md-6 col-lg-6">
        <div class="page-header">
            <h1><?php echo $this->lang->line('list') ,' ', $this->lang->line('villages'), ' ('. @$count .')'; ?></h1>
        </div>
    </div>

    <?php if (hasPermission('villages', 'addTender')) { ?>
        <div class="col-sm-12 col-sm-6 col-md-6 col-lg-6">
            <div class="page-header text-right">
                <h1><a class="btn btn-green" href="<?php echo USER_URL . 'village/add'; ?>" data-toggle="tooltip" title="" data-original-title="<?php echo $this->lang->line('add'); ?>"><i class="clip-plus-circle"></i>&nbsp;<?php echo $this->lang->line('add') .' '. $this->lang->line('village'); ?></a></h1>
            </div>
        </div>
    <?php } ?>
</div>
        ...
        <div id="mainpanel" class="box-body table-responsive">
            <table class="table table-bordered table-hover" id="list_data">
                <thead class="the-box dark full">
                    <tr align="left">
                        <th><?php echo $this->lang->line('village_name'); ?></th>
