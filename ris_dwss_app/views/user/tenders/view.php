...
<script type="text/javascript" >
    ...
    function loadDatatable(){
        ...
        dTable=jQuery('#list_data').dataTable({
            ...
            "sAjaxSource": "<?php echo USER_URL . 'tender/getjson?status='; ?>" + jQuery('#status').val() + '&start_date=' + jQuery('#start_date').val() + '&end_date=' + jQuery('#end_date').val(),
        });
    }
    ...
    <?php if (hasPermission('tenders', 'addTender')) { ?>
        <div class="col-sm-12 col-sm-6 col-md-6 col-lg-6">
            <div class="page-header text-right">
                <h1><a class="btn btn-green" href="<?php echo USER_URL . 'tender/add'; ?>" data-toggle="tooltip" title="" data-original-title="<?php echo $this->lang->line('add'); ?>"><i class="clip-plus-circle"></i>&nbsp;<?php echo $this->lang->line('add') .' '. $this->lang->line('tender'); ?></a></h1>
            </div>
        </div>
    <?php } ?>
</div>
        ...
        <div class="row">
            <div class="col-sm-12 col-sm-4 col-md-4 col-lg-4">
                <div class="form-group">
                    <label class="control-label"><?php echo $this->lang->line('tender_status'); ?></label>
                    <div>
            ...
            <div class="col-sm-12 col-sm-4 col-md-4 col-lg-4">
                <div class="form-group">
                    <label class="control-label"><?php echo $this->lang->line('tender_start_date'); ?></label>
                    <div>
            ...
            <div class="col-sm-12 col-sm-4 col-md-4 col-lg-4">
                <div class="form-group">
                    <label class="control-label"><?php echo $this->lang->line('tender_end_date'); ?></label>
                    <div>
