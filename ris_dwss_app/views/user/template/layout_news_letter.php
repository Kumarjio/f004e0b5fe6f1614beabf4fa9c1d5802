          ...
          <table width="70" align="left" border="0" cellpadding="0" cellspacing="0">  
            <tr>
              <td height="70" style="padding: 0 20px 20px 0;">
                <img class="fix" src="http://rootitsolutions.com/wp-content/uploads/2014/10/root_it_solutions_logo.png" width="70" height="70" border="0" alt="" style="height: auto;"/>
              </td>
            </tr>
          </table>
          <!--[if (gte mso 9)|(IE)]>
          ...
          <table width="115" align="left" border="0" cellpadding="0" cellspacing="0">  
            <tr>
              <td height="115" style="padding: 0 20px 20px 0;">
                <img class="fix" src="http://rootitsolutions.com/wp-content/uploads/2014/10/root_it_solutions_logo.png" width="115" height="115" border="0" alt="" style="height: auto;"/>
              </td>
            </tr>
          </table>
          <!--[if (gte mso 9)|(IE)]>
                  ...
                  <tr>
                    <td width="37" style="text-align: center; padding: 0 10px 0 10px;">
                      <a href="http://www.facebook.com/">
                        <img src="http://rootitsolutions.com/wp-content/uploads/2014/10/root_it_solutions_logo.png" width="37" height="37" alt="Facebook" border="0" style="height: auto;"/>
                      </a>
                    </td>
                    <td width="37" style="text-align: center; padding: 0 10px 0 10px;">
                      <a href="http://www.twitter.com/">
                        <img src="http://rootitsolutions.com/wp-content/uploads/2014/10/root_it_solutions_logo.png" width="37" height="37" alt="Twitter" border="0" style="height: auto;"/>
                      </a>
                    </td>
                  </tr>
                </table>
