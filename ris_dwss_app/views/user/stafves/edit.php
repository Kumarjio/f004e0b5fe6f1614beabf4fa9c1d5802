...
<div class="row">
    <div class="col-sm-12">
        <div class="page-header">
            <h1><?php echo $this->lang->line('edit') ,' ', $this->lang->line('staff'); ?></h1>
        </div>
    </div>
</div>
        ...
        <form id="edit" method="post" class="form-horizontal" action="<?php echo USER_URL . 'staff/edit/' . $staff->id; ?>" enctype="multipart/form-data">
            ...
            <?php foreach ($this->config->item('custom_languages') as $key => $value) { ?>
                <div class="form-group">
                    ...
                    <div class="col-lg-9">
                        <input type="text" name="<?php echo $key . '_name'; ?>"  class="<?php echo ($key == 'en') ? 'form-control required' : 'form-control'; ?>" placeholder="<?php echo $this->lang->line('staff_name'), ' ', ucwords($value); ?>" value="<?php echo $staff->{$key . '_name'} ?>"/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-9">
                        <input type="text" name="<?php echo $key . '_position'; ?>"  class="form-control" placeholder="<?php echo $this->lang->line('staff_position'), ' ', ucwords($value); ?>"  value="<?php echo $staff->{$key . '_position'} ?>"/>
                    </div>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-9">
                    <label class="radio-inline">
                        <input type="radio" value="1" name="status" class="square-grey" <?php echo ($staff->status == 1) ? 'checked' : ''; ?>>
                        <?php echo $this->lang->line('active'); ?>
                    </label>
                    <label class="radio-inline">
                        <input type="radio" value="0" name="status" class="square-grey" <?php echo ($staff->status == 0) ? 'checked' : ''; ?>>
