        ...
        <form id="add" method="post" class="form-horizontal" action="<?php echo USER_URL . 'staff/add'; ?>" enctype="multipart/form-data">
            ...
            <?php foreach ($this->config->item('custom_languages') as $key => $value) { ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-9">
                        <input type="text" name="<?php echo $key . '_number'; ?>"  class="form-control" placeholder="<?php echo $this->lang->line('staff_number'), ' ', ucwords($value); ?>"/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-9">
                        <textarea name="<?php echo $key . '_address'; ?>"  class="form-control" placeholder="<?php echo $this->lang->line('staff_address'), ' ', ucwords($value); ?>" rows="5"></textarea>
                    </div>
                </div>
