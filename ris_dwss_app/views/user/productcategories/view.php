...
<script type="text/javascript" >
    ...
    function loadDatatable(){
        ...
        dTable=jQuery('#list_data').dataTable({
            ...
            "sAjaxSource": "<?php echo USER_URL . 'productcategory/getjson?market_id='; ?>" + jQuery('#market_id').val(),
        });
    }
        ...
        swal(
            ...
            function(isConfirm){
                if (isConfirm) {
                    jQuery.ajax({
                        type: 'POST',
                        url: http_host_js + 'productcategory/delete/' + current_id,
                        data: id = current_id,
                        dataType : 'JSON',
...
<div class="row">
    ...
    <?php if (hasPermission('productcategories', 'addProductcategory')) { ?>
        <div class="col-sm-12 col-sm-6 col-md-6 col-lg-6">
            <div class="page-header text-right">
                <h1><a class="btn btn-green" href="<?php echo USER_URL . 'productcategory/add'; ?>" data-toggle="tooltip" title="" data-original-title="<?php echo $this->lang->line('add'); ?>"><i class="clip-plus-circle"></i>&nbsp;<?php echo $this->lang->line('add') .' '. $this->lang->line('product_category'); ?></a></h1>
            </div>
        </div>
    <?php } ?>
</div>
            ...
            <table class="table table-bordered table-hover" id="list_data">
                <thead class="the-box dark full">
                    <tr align="left">
                        ...
                        <th width="150"><?php echo $this->lang->line('product_category_total_product'); ?></th>
                        <th width="150"><?php echo $this->lang->line('product_category_image'); ?></th>
