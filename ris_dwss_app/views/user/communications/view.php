...
<div class="row">
    <div class="col-sm-12 col-sm-6 col-md-6 col-lg-6">
        <div class="page-header">
            <h1><?php echo $this->lang->line('communication_listsms'); ?></h1>
        </div>
    </div>
    ...
    <?php if (hasPermission('communications', 'sendSmsCommunication')) { ?>
        <div class="col-sm-12 col-sm-6 col-md-6 col-lg-6">
            <div class="page-header text-right">
                <h1><a class="btn btn-green" href="<?php echo USER_URL . 'communication/sms/send'; ?>" data-toggle="tooltip" title="" data-original-title="<?php echo $this->lang->line('communication_sendsms'); ?>"><i class="clip-plus-circle"></i>&nbsp;<?php echo $this->lang->line('communication_sendsms'); ?></a></h1>
            </div>
        </div>
    <?php } ?>
</div>
            ...
            <table class="table table-bordered table-hover" id="list_data">
                <thead class="the-box dark full">
                    <tr align="left">
                        ...
                        <th width="100"><?php echo $this->lang->line('communication_mobile_no'); ?></th>
                        <th width="200"><?php echo $this->lang->line('communication_description'); ?></th>
                        <th width="100"><?php echo $this->lang->line('communication_status'); ?></th>
