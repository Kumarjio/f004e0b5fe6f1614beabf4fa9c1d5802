...
<div class="row">
    <div class="col-sm-12">
        <div class="page-header">
            <h1><?php echo $this->lang->line('add') ,' ', $this->lang->line('news'); ?></h1>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-lg-12">
        <form id="add" method="post" class="form-horizontal" action="<?php echo USER_URL . 'latestnews/add'; ?>">
            ...
            <?php foreach ($this->config->item('custom_languages') as $key => $value) { ?>
                <div class="form-group">
                    ...
                    <div class="col-lg-9">
                        <input type="text" name="<?php echo $key . '_name'; ?>"  class="<?php echo ($key == 'en') ? 'form-control required' : 'form-control'; ?>" placeholder="<?php echo $this->lang->line('news'), ' ', $this->lang->line('news_name'), ' ', ucwords($value); ?>"/>
                    </div>
                </div>
            <?php } ?>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-9">
                    <input type="text" name="start_date"  class="form-control required date-picker" placeholder="<?php echo $this->lang->line('news_start_date'); ?>"/>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-9">
                    <input type="text" name="end_date"  class="form-control required date-picker" placeholder="<?php echo $this->lang->line('news_end_date'); ?>"/>
                </div>
            </div>
