        ...
        swal(
            ...
            function(isConfirm){
                if (isConfirm) {
                    jQuery.ajax({
                        type: 'POST',
                        url: http_host_js + 'selloffer/delete/' + current_id,
                        data: id = current_id,
                        dataType : 'JSON',
...
<div class="row">
    <div class="col-sm-12 col-sm-6 col-md-6 col-lg-6">
        <div class="page-header">
            <h1><?php echo $this->lang->line('list') ,' ', $this->lang->line('selloffer'), ' ('. @$count .')'; ?></h1>
        </div>
    </div>
...
<div class="panel panel-default">
    ...
    <div class="panel-body">   
        <div class="row">
            ...
            <div class="col-sm-12 col-sm-4 col-md-4 col-lg-4">
                <div class="form-group">
                    <label class="control-label"><?php echo $this->lang->line('selloffer_start_date'); ?></label>
                    <div>
            ...
            <div class="col-sm-12 col-sm-4 col-md-4 col-lg-4">
                <div class="form-group">
                    <label class="control-label"><?php echo $this->lang->line('selloffer_end_date'); ?></label>
                    <div>
            ...
            <table class="table table-bordered table-hover" id="list_data">
                <thead class="the-box dark full">
                    <tr align="left">
                        ...
                        <th width="100"><?php echo $this->lang->line('selloffer_status'); ?></th>
