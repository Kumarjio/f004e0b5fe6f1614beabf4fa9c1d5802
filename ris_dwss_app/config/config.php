...
if (isset($_SERVER) && $_SERVER['SERVER_ADDR'] == '127.0.0.1') {
  ...
  $config['base_url'] = $http .'labs.rootitsolutions.com/apmc/';
}
...
if (!defined('USER_ASSETS_URL')) {
    define('USER_ASSETS_URL', ASSETS_URL . 'user_assets/');
}

if (!defined('USER_URL')) {
    define('USER_URL', $config['base_url'] . 'user/');
}

if (!defined('USER_CSS_URL')) {
    define('USER_CSS_URL', ASSETS_URL . 'user_assets/css/');
}

if (!defined('USER_JS_URL')) {
    define('USER_JS_URL', ASSETS_URL . 'user_assets/js/');
}

if (!defined('USER_FONT_URL')) {
    define('USER_FONT_URL', ASSETS_URL . 'user_assets/fonts/');
}

if (!defined('USER_IMG_URL')) {
    define('USER_IMG_URL', ASSETS_URL . 'user_assets/images/');
}
